...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  function Greet2() {
    return react.default.createElement("h1", null, "Hello Lachin");
  }
  const Greet_default = Greet2;

  // src/components/Welcome.js
  const react2 = __toModule(require_react());
  class Welcome2 extends react2.Component {
    render() {
      return react2.default.createElement("h1", null, "Class Component");
    }
  }
  ...
  const App = () => {
    ...
    return React.createElement("div", null, React.createElement(Greet_default, null), React.createElement(Welcome_default, null));
  };
